...
const onEventClick = async ({event}) => {
    open.value = true
    eventDetails.value = await wire.fetchDetails(event.id)
...
const calendarOptions = {
    ...
    initialView: mingleData.view,
    events: mingleData.events,
                                                        ...
                                                        <div class="mt-6 sm:ml-6 sm:flex-1">
                                                            <div>
                                                                <div class="flex items-center">
                                                                    ...
                                                                    <span class="ml-2.5 inline-block h-2 w-2 flex-shrink-0 rounded-full" v-bind:class="{
                                                                        'bg-green-400': eventDetails.status === 'confirmed',
                                                                        'bg-yellow-400': eventDetails.status === 'tentative',
                                                                        'bg-orange-400': eventDetails.status === 'invited',
                                                                        'bg-red-400': eventDetails.status === 'cancelled',
                                                                    }">
                                                                        <span class="sr-only">{{ eventDetails.status }}</span>
                                                                    </span>
                                                                </div>
                                                                <p class="text-sm text-gray-500">Organized by {{ eventDetails.organizer }}</p>
                                                            </div>
